...
struct ScrollReaderView: View {
    ...
    private func paragraphView(index: Int, text: String) -> some View {
        ...
        let isBookmarked = bookmarkedIndices.contains(index)
        ...
        .sensoryFeedback(.impact(weight: .medium), trigger: isBookmarked)
    }
